...
# 1. خادم ويب مصغر للحفاظ على عمل Render 24/7
...
BOT_TOKEN = os.getenv("BOT_TOKEN", "ضع_توكن_التيليجرام_هنا")
...
def callback_handler(call):
    ...
    if call.data == "check_balance":
        ...
        bot.answer_callback_query(call.id)
        bot.send_message(chat_id, "📌 تعليمات:\nاضغط على شراء رقم، أدخله في التطبيق، وسيعرض البوت الكود فور وصوله.")
