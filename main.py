...
RUB_PER_USD = 30.0
PAGE_SIZE = 12  # عدد الدول في كل صفحة
...
print(f"🚀 Initializing High-Performance Ultra Bot with 3 Servers & Free Transfers...")
...
# نظام صفحات الدول (Pagination) بأسمائهم وأعلامهم فقط
    ...
    try:
        ...
        if action == "transfer_step_1_id":
            ...
            try:
                ...
                # تنفيذ التحويل المالي المجاني فوراً
        ...
        # 3. شحن وخصم يدوي من الإدارة (تفعيل كامل)
...
def start_bot():
    ...
    print("🚀 BOT WITH 3 SERVERS, GLOBAL COUNTRIES & FREE TRANSFERS IS LIVE 24/7...")
