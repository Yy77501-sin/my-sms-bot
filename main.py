...
print(f"--- Starting Number SMS Bot Engine ---")
print(f"Bot Token Loaded: {BOT_TOKEN[:10]}... (Total len: {len(BOT_TOKEN)})")
...
class HealthCheckHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        return  # كتم سجلات الفحص الصحي لعدم ملء الشاشة
...
def start_bot():
    ...
    print("🚀 BOT IS NOW RUNNING & READY TO RECEIVE MESSAGES 24/7...")
