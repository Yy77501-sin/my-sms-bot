# ==========================================
# كتالوج الخدمات والتطبيقات المدعومة للأرقام
# ==========================================
...
# ==========================================
# السيرفرات الثلاثة المتخصصة
# ==========================================

SERVERS = {
    "s1": {
        "title": "🌟 السيرفر (1) VIP الملكي - أعلى جودة وسرعة",
        "badge": "VIP"
    },
    "s2": {
        "title": "⚡ السيرفر (2) السريع الاقتصادي - أفضل سعر",
        "badge": "ECO"
    },
    "s3": {
        "title": "🎯 السيرفر (3) الاحتياطي الشامل - أكثر توفراً",
        "badge": "PRO"
    }
}
...
COUNTRIES = {
    ...
    "14": {"name": "israel", "title": "إسرائيل", "flag": "🇮🇱", "prefix": "+972", "base_usd": 26.0},
...
# ==========================================
# كتالوج خدمات الرشق وشحن الألعاب (SMM)
# ==========================================
